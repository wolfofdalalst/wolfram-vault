...
class App(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        self.frame_left = customtkinter.CTkFrame(
            master=self, width=350, corner_radius=0, height=150
        )
        ...
        self.title = customtkinter.CTkLabel(
            master=self.frame_left, text="WolframPass", text_font=("Overpass", 20)
        )
        self.title.grid(row=1, column=0, pady=10, padx=10)

        self.about = customtkinter.CTkButton(
            master=self.frame_left, text="About", text_font=("Overpass", "15")
        )
